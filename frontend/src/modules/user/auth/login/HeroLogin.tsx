              ...
              <form onSubmit={handleSubmitPhone} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 px-4 border-2 border-gray-100 rounded-xl hover:bg-gray-50 transition-all font-semibold text-sm text-gray-700"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 px-4 border-2 border-[#1877F2] bg-[#1877F2] hover:bg-[#166fe5] rounded-xl transition-all font-semibold text-sm text-white shadow-md shadow-blue-100"
                  >
